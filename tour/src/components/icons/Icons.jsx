...
export function IconPencilSmall() {
  return (
    <svg className="trip-card-act-icon" width="16" height="16" viewBox="0 0 24 24" aria-hidden>
      <path
        fill="currentColor"
...
export function IconTrashSmall() {
  return (
    <svg className="trip-card-act-icon" width="16" height="16" viewBox="0 0 24 24" aria-hidden>
      <path
        fill="currentColor"
...
export function IconCalendarSimple() {
  return (
    <svg
...
export function IconFeaturePlans() {
  return (
    <svg
...
export function IconFeatureMap() {
  return (
    <svg
      className="feature-icon feature-icon--stroke"
      width="44"
...
export function IconFeatureWallet() {
  return (
    <svg
      className="feature-icon feature-icon--stroke"
      width="44"
...
export function IconFeatureSaved() {
  return (
    <svg
      className="feature-icon feature-icon--stroke"
      width="44"
