...
export const tripDriveLinks = [
  {
    label: "行程總表",
    href: "https://docs.google.com/spreadsheets/d/1HGpzva3QmlBx_1Eq9Kdj0yd4Vi_00KRW0rI-O24noQE/htmlview",
    from: "Google 試算表",
  },
  {
    label: "證件",
    href: "https://drive.google.com/drive/folders/1mDfmhgRYscrsvhI6PY8SJIgLGieik5Pj",
  },
  {
    label: "訂位/票券",
    href: "https://drive.google.com/drive/folders/13WZA2Nhrd0ms3bnN3WkyVxz1cLmpX-ZQ",
  },
  {
    label: "機票",
    href: "https://drive.google.com/drive/folders/1HBqZNNU6W-Y2jYHuce0l5Hqup6QylDqJ",
  },
  {
    label: "住宿",
    href: "https://drive.google.com/drive/folders/1X0a38GZxkc0ZXJnVwLQ7elinHshHlDB2",
  },
];
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            title: "Bedouin",
            detail:
              "吃飯時再訂回程車票 · 截圖：18 May Dinner - bedouin cambridge.png",
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            detail:
              "訂票（TWD 930）。原表列在 5/20 區塊，與當日下午抵達衝突，此處依「抵達翌日上午」編排。",
            emphasis: "booking",
          },
          {
            type: "activity",
    ...
    days: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            detail:
              "阿拉伯聯合大公國阿布達比 · 扎耶德機場（AUH）→ 韓國首爾仁川機場（ICN）",
            emphasis: "booking",
          },
          {
            type: "activity",
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            title: "返國",
            detail:
              "韓國首爾金浦機場（GMP）出發 → 台北松山（TSA）或 金門（KNH）機場（依實際機票）",
          },
          {
            type: "activity",
            title: "首爾金浦（GMP）機場",
...
function chronTupleForDayId(dayId) {
  ...
  if (!m) return [0, 0, id];
  const n =
    parseInt(m[1], 10) * 10000 + parseInt(m[2], 10) * 100 + parseInt(m[3], 10);
